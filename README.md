...
<p data-visibility='hidden'>View <a href='https://learn.co/lessons/cssi-2.3-functions' title='Functions'>Functions</a> on Learn.co and start learning to code for free.</p>
